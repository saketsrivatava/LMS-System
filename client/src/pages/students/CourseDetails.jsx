                  ...
                  <div className={`overflow-hidden transition-all duration-300 ${openSections[index] ? 'max-h-96' : 'max-h-0'}`}>
                    <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300 ">
                      {chapter.chapterContent.map((lecture, lectureId) => (
                        <li key={lectureId} className="flex items-center justify-between w-full text-gray-800 text-xs md:text-default pb-3">
                          <img
          ...
          <div className="p-5">
            ...
            <div>
              ...
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                ...
                <li>Step-by-step, hands-on project gyidance.</li>
                <li>Downloadable resources ad source code.</li>
