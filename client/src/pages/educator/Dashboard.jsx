      ...
      <div className='space-y-5'>
        <div className='flex flex-wrap gap-5 items-center'>
          ...
          <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md'>
            ...
            <div>
              <p className='text-2xl font-medium text-gray-600'>{dashboardData.enrolledStudentsData.totalCourses}
              </p>
          ...
          <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md'>
            ...
            <div>
              <p className='text-2xl font-medium text-gray-600'>{currency} {dashboardData.enrolledStudentsData.totalEarnings}
              </p>
