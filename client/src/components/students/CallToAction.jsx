...
const CallToAction = () => {
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>Unlock your potential with courses designed for every skill level, available wherever and whenever you are ready to learn.</p>
