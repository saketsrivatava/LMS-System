  ...
  return (
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      <div className='flex flex-col md:flex-row items-start justify-center gap-10 md:gap-32 border-b border-white/30 text-white/80 py-10 px-8 md:px-0 space-y-6 md:space-y-0'>
        ...
        <div className='hidden md:flex flex-col items-start  w-full gap-4'>
      ...
      <p className=' text-white/60 py-4 text-xs md:text-sm text-center'>Copyright 2024 © Edemy. All Right Reserved.</p>
    </footer>
  )
}
